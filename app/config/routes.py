...
"""
routes['default_controller'] = 'Lenders'
routes['POST']['/lenders'] = 'Lenders#register_lender'
routes['POST']['/borrowers'] = 'Lenders#register_borrower'
routes['/lenders/home'] = 'Lenders#lender_home'
routes['/borrowers/home'] = 'Lenders#borrower_home'
routes['/signin'] = 'Lenders#login_view'
routes['POST']['/login'] = 'Lenders#login'
routes['/logout'] = 'Lenders#logout'
routes['POST']['/lend/<bor_id>'] = 'Lenders#lend'
